...
function renderAccounting() {
  ...
  // Kompatibilitas data lama: jika servis DIAMBIL belum pernah membuat
  // ledger, tampilkan sebagai pemasukan satu kali tanpa menggandakan
  // transaksi yang sudah punya referensi ledger.
  ...
  $("#ledger-list").innerHTML = displayRows.slice(0, 100).map(x => `<tr>
    <td>${new Date(x.tanggal || 0).toLocaleDateString("id-ID")}</td>
