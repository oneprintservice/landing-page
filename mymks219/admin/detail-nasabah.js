...
async function loadDetailNasabah() {
    ...
    const sc=Number(nasabah.credit_score??10); if(document.getElementById("scoreNasabah")) document.getElementById("scoreNasabah").textContent=sc+"/10"; if(document.getElementById("scoreLabelNasabah")) document.getElementById("scoreLabelNasabah").textContent=kspScoreLabel(sc);
